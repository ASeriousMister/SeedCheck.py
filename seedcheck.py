...
if (is_electrum and online_check):
    ...
    # https://blockchain.info/q/addressfirstseen/bc1q3xmzcgxfa56wzesxe8kuaahfemutxjy7xath6w
...
if (online_found == False and online_check == True and (is_bip39 == True or is_electrum == True)):
    print('It was not possible to determinate the derivation path used with the given seed or it maybe it was never used')
